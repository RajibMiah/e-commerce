...
export const ProductInfo = styled.div`
  ...
  .product-weight {
    ...
    color: ${themeGet('colors.text.regular', '#6e6f7b')};
    font-weight: bold;
    @media (max-width: 767px) {
  ...
  .product-meta {
    ...
    .productPriceWrapper {
      ...
      .discountedPrice {
        font-family: ${themeGet('fonts.body', 'sans-serif')};
        font-size: ${themeGet('fontSizes.sm', '13')}px;
        font-weight: ${themeGet('fontWeights.regular', '500')};
          //color: ${themeGet('colors.yellow.hover', '#87899a')};
        color: #87899a;
        font-style: italic;
        padding: 0 5px;
        position: relative;
        ...
        &:before {
          ...
          height: 1px;
          display: inline-block;
          background-color: #87899a; //${themeGet('colors.yellow.hover', '#FBB979')};
          position: absolute;
          top: 50%;
          left: 0;
        }
    ...
    .cart-button {
      border: 2px solid #0061004f; //${themeGet('colors.gray.200', '#0061004f')};
    ...
    .out-of-stock-button {
      //border: 1px solid rgb(255 91 96);
      border-radius: 7px;
      height: 36px;
      /* padding-left: 17px;
      padding-right: 17px; */
      width: 7.5rem;
      background: rgb(255 91 96);
      color: white;
      //color: rgb(255 91 96);
      font-size: ${themeGet('fontSizes.sm', '17')}px;
      font-weight: ${themeGet('fontWeights.bold', '700')};

      &:hover {
        background-color: rgb(255 91 96 / 62%) !important;
